...
describe('index', () => {
  it('runs getMake', () => {
    ...
    expect(getMake({ vin: 'TYBFB83BD4DU19451' })).toBe(Make.FUSO)
    ...
    expect(getMake({ vin: 'LSGH2CEC4MA362596' })).toBe(Make.CHEVROLET)
    expect(getMake({ vin: 'MA6H2CEC4MA362596' })).toBe(Make.GMC)
    expect(getMake({ vin: 'MCBH2CEC4MA362596' })).toBe(Make.GMC)
    expect(getMake({ vin: 'XUFH2CEC4MA362596' })).toBe(Make.GMC)
    expect(getMake({ vin: '1GTH2CEC4MA362596' })).toBe(Make.GMC)
    expect(getMake({ vin: '2GxH2CEC4MA362596' })).toBe(Make.GMC)
    expect(getMake({ vin: '6G1H2CEC4MA362596' })).toBe(Make.CHEVROLET)
    expect(getMake({ vin: '6H8H2CEC4MA362596' })).toBe(Make.HOLDEN)
    expect(getMake({ vin: '2G0H2CEC4MA362596' })).toBe(Make.GMC)
    expect(getMake({ vin: '2GJH2CEC4MA362596' })).toBe(Make.GMC)
    expect(getMake({ vin: '1GJH2CEC4MA362596' })).toBe(Make.GMC)
    expect(getMake({ vin: '3GJH2CEC4MA362596' })).toBe(Make.GMC)
